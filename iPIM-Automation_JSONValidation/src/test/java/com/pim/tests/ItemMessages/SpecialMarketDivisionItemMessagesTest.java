...
public class SpecialMarketDivisionItemMessagesTest extends BaseTest{
	...
	private SpecialMarketDivisionItemMessagesTest(){
	}
	// ITM_023
	...
	@Test(description = "ITM_023 | Verifying Item Error Message for SpecialMarket Division US, and Master Catalog", groups = {"US","pim","ITEM_MESSAGES"}, dataProvider = "getCatalogData", dataProviderClass = DataProviderUtils.class)
	...
	@PimFrameworkAnnotation(module = Modules.ITEM_MESSAGES, category = CategoryType.REGRESSION)
	@TestDataSheet(sheetname = TestCaseSheet.ItemErrorMessageTestData)
	@Test(description = "ITM_038 | Verifying Item Warning Message for SpecialMarket Division US, and Master Catalog",groups = {"US","pim","ITEM_MESSAGES"}, dataProvider = "getCatalogData", dataProviderClass = DataProviderUtils.class)
	...
	@PimFrameworkAnnotation(module = Modules.ITEM_MESSAGES, category = CategoryType.REGRESSION)
	@TestDataSheet(sheetname = TestCaseSheet.ItemErrorMessageTestData)
	@Test(description = "ITM_033 | Verifying Error Global Message for SpecialMarket Item US, and Master Catalog",groups = {"US","pim","ITEM_MESSAGES"}, dataProvider = "getCatalogData", dataProviderClass = DataProviderUtils.class)
	public void verifyErrorGlobalMessageForSpecialMarketItem(Map<String, String> map)   
	{
		PimHomepage pimHomepage = new LoginPage()
				.enterUserName(ExcelUtils.getLoginData().get("US User").get("UserName"))
				.enterPassword(ExcelUtils.getLoginData().get("US User").get("Password")).clickLoginButton();
		...
		log(LogType.INFO, "Verifying Delete Error Global Messages For SpecialMarket Item ");
		...
		log(LogType.INFO, "Verifying Assign Error Global Messages For SpecialMarket Item ");
		...
		//Verify Error msg in master catalog
		log(LogType.INFO, "Verify Error Global Messages For SpecialMarket Item in Master");
	...
	@PimFrameworkAnnotation(module = Modules.ITEM_MESSAGES, category = CategoryType.REGRESSION)
	@TestDataSheet(sheetname = TestCaseSheet.ItemErrorMessageTestData)
	@Test(description = "ITM_038 | Verifying Warning Global Message for SpecialMarket Item US, and Master Catalog", groups = {"US","ITEM_MESSAGES"},dataProvider = "getCatalogData", dataProviderClass = DataProviderUtils.class)
	public void verifyWarningGlobalMessageForSpecialMarketItem(Map<String, String> map) throws IOException, InterruptedException, AWTException  
	{
		PimHomepage pimHomepage = new LoginPage()
				.enterUserName(ExcelUtils.getLoginData().get("US User").get("UserName"))
				.enterPassword(ExcelUtils.getLoginData().get("US User").get("Password")).clickLoginButton();
		...
		log(LogType.INFO, "Verifying Delete Warning Messages");
		...
		log(LogType.INFO, "Verifying Assign Warning Messages");
	...
	@PimFrameworkAnnotation(module = Modules.ITEM_MESSAGES, category = CategoryType.REGRESSION)
	@TestDataSheet(sheetname = TestCaseSheet.ItemErrorMessageTestData)
	@Test(description = "ITM_043 | Verifying Add SpecialMarket Error Message for multiple item code in US, and Master Catalog",groups = {"US","ITEM_MESSAGES"}, dataProvider = "getCatalogData", dataProviderClass = DataProviderUtils.class)
	public void verifyAddItemErrorMessageForMultipleItemCodeInSpecialMarketDivision(Map<String, String> map) throws IOException, InterruptedException, AWTException  
	{
		PimHomepage pimHomepage = new LoginPage()
				.enterUserName(ExcelUtils.getLoginData().get("US User").get("UserName"))
				.enterPassword(ExcelUtils.getLoginData().get("US User").get("Password")).clickLoginButton();
...
//		pimHomepage.mainMenu().clickQueriesMenu().selectCatalogType(map.get("MasterCatalog"));
	...
	@PimFrameworkAnnotation(module = Modules.ITEM_MESSAGES, category = CategoryType.REGRESSION)
	@TestDataSheet(sheetname = TestCaseSheet.ItemErrorMessageTestData)
	@Test(description = "WRFL_019 | Verify CatalogEntityRules are executed for SpecialMarketPrivilege User",groups = {"US","ITEM_MESSAGES"}, dataProvider = "getCatalogData", dataProviderClass = DataProviderUtils.class)
	public void verifyCatalogEntityRulesAreExecutedForSpecialMarketUser(Map<String, String> map)
	{
		PimHomepage pimHomepage = new LoginPage()
				.enterUserName(ExcelUtils.getLoginData().get("US User").get("UserName"))
				.enterPassword(ExcelUtils.getLoginData().get("US User").get("Password")).clickLoginButton();

		//Verify Deleted special market division message code
		pimHomepage.mainMenu().clickQueriesMenu().selectItemType(map.get("ItemTypeInQueriesMenu"))
		.selectCatalogType(map.get("CatalogType"))
		.enterHsiItemNumber(map.get("ItemNumber"));
		queriesSubMenu.clickSeachButton();
		...
		//Verify Assigned special market division message code
		pimHomepage.mainMenu().clickQueriesMenu();
		pimHomepage.mainMenu().clickQueriesMenu().selectCatalogType(map.get("CatalogType"));
		queriesSubMenu.clickSeachButton();
		structuresubmenu.clickOnFirstItemCode();
		...
		//Verify assigned special market division msg in Master catalog
		pimHomepage.mainMenu().clickQueriesMenu().selectCatalogType(map.get("MasterCatalog"));
		queriesSubMenu.clickSeachButton();
		structuresubmenu.clickOnFirstItemCode();
		productDetailSearchPage.selectTabfromDropdown(map.get("ClassificationTab"));
